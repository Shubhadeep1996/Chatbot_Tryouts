...
add_on_greet = ", my name is VIKI-Bot. You can consult me for RKNEC-related queries!"
...
FAREWELL_KEYWORDS = ("bye", "sayonara", "astalavista", "farewell","adieu")

FAREWELL_RESPONSES = ["Bye", "Farewell", "See you later", "Sayonara", "Adieu"]
